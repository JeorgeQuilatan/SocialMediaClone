				...
				$like_count = count($likes);
			 	...
			 	if($like_count > 0){
			 		...
			 		if($like_count == 1){
			 			...
			 			if($i_liked){
			 				$info .= "<div style='text-align:left;color: black;'>You liked this post </div>";
			 			}else{
			 				$info .= "<div style='text-align:left;color: black;'> 1 person liked this post </div>";
			 			}
			 		}else{
			 			...
			 			if($i_liked){
			 				...
			 				$info .= "<div style='text-align:left;color: black;'> You and " . ($like_count - 1) . " $text liked this post </div>";
			 			}else{
			 				$info .= "<div style='text-align:left;color: black;'>" . $like_count . " other liked this post </div>";
			 			}
			 		}
